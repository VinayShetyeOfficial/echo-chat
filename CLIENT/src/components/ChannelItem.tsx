      ...
      if (lastMessage) {
        ...
        if (plainMessageText) {
          if (isCurrentUserSender) {
            formattedMsg = `You: ${plainMessageText}`;
          } else {
            ...
            if (
              ...
              formattedMsg = `${messageSender.username}: ${plainMessageText}`;
            } else {
              formattedMsg = plainMessageText;
            }
          }
        } else if (
          ...
          if (isCurrentUserSender) {
            formattedMsg = `You sent an ${attachmentType}`;
          } else {
            if (
              channel.type === "direct" &&
              messageSender &&
              ...
              formattedMsg = `${messageSender.username} sent an ${attachmentType}`;
            } else {
              formattedMsg = `${
