  ...
  switch (channelId) {
    case "channel1": // general channel
      channelMessages.push(
        ...
        createMessage(
          ...
          "user3",
          channelId,
          new Date(now.getTime() - 86400000 * 3 + 3600000),
        ),
        createMessage(
          "msg3",
          "What projects are we working on this week?",
          "user2",
          channelId,
        ...
        createMessage(
          "msg4",
          "I'm starting the new design system implementation.",
          "user1",
          channelId,
          new Date(now.getTime() - 86400000 * 2 + 3600000),
        ),
        createMessage(
          "msg5",
        ...
        createMessage(
          "msg6",
          "I'll be sharing the prototype by Friday.",
          "user1",
          channelId,
          new Date(now.getTime() - 3600000 * 5),
          undefined,
          [
    ...
    case "channel2": // design channel
      channelMessages.push(
        createMessage(
          "msg7",
          "I've uploaded the new logo designs for review",
          "user1",
          channelId,
          new Date(now.getTime() - 86400000 * 2),
          [
        ...
        createMessage(
          "msg8",
          "These look amazing! I especially like the third variant.",
          "user4",
          channelId,
          new Date(now.getTime() - 86400000 * 2 + 3600000),
        ),
        createMessage(
          "msg9",
          "Thanks! I'll refine the third one based on yesterday's feedback.",
          "user1",
          channelId,
          new Date(now.getTime() - 86400000 * 1),
        ),
        createMessage(
          "msg10",
          "Can we schedule a design review meeting tomorrow?",
          "user5",
          channelId,
          new Date(now.getTime() - 3600000 * 8),
        ),
      )
      break
    ...
    case "channel3": // development channel
      channelMessages.push(
        createMessage(
          "msg11",
          "Has anyone set up the new build pipeline yet?",
          "user3",
          channelId,
          new Date(now.getTime() - 86400000 * 2),
        ),
        createMessage(
          "msg12",
          "I'm working on it now. Should be ready for testing in a few hours.",
          "user2",
          channelId,
          new Date(now.getTime() - 86400000 * 2 + 3600000),
        ),
        createMessage(
          "msg13",
          "Here's the documentation for our new API endpoints",
          "user2",
          channelId,
          new Date(now.getTime() - 86400000 * 1),
          [
        ...
        createMessage(
          "msg14",
          "Thanks for this! I'm reviewing it now and will follow up with questions.",
          "user7",
          channelId,
          new Date(now.getTime() - 3600000 * 2),
        ),
      )
      break
    ...
    case "channel4": // Direct message with Alice
      channelMessages.push(
        createMessage(
          "msg15",
          "Hi! Do you have a moment to discuss the analytics dashboard?",
          "user1",
          channelId,
          new Date(now.getTime() - 86400000 * 1),
        ),
        createMessage(
          ...
          "currentUser",
          channelId,
          new Date(now.getTime() - 86400000 * 1 + 3600000),
        ),
        createMessage(
          "msg17",
          "I'm noticing that the real-time data isn't updating correctly.",
          "user1",
          channelId,
          new Date(now.getTime() - 86400000 * 1 + 3600000 * 2),
        ),
        createMessage(
          "msg18",
          "Let me check that for you. Can you send me a screenshot of what you're seeing?",
          "currentUser",
          channelId,
          new Date(now.getTime() - 86400000 * 1 + 3600000 * 3),
        ),
        createMessage(
          "msg19",
          "Here it is. Notice how the charts are stuck at yesterday's data.",
          "user1",
          channelId,
          new Date(now.getTime() - 86400000 * 1 + 3600000 * 4),
          [
            {
              id: "attachment3",
              type: "image",
    ...
    case "channel5": // Direct message with Bob
      channelMessages.push(
        createMessage(
          "msg20",
          "Hi there! Just checking if you'll be at the team lunch tomorrow?",
          "currentUser",
          channelId,
          new Date(now.getTime() - 86400000 * 2),
        ),
        ...
        createMessage(
          "msg22",
          "Great! I heard the new restaurant has an amazing menu.",
          "currentUser",
          channelId,
          new Date(now.getTime() - 86400000 * 2 + 3600000 * 2),
        ),
        createMessage(
          "msg23",
          "I recorded a voice note with directions to the place",
          "user2",
          channelId,
          new Date(now.getTime() - 3600000 * 4),
          [
            {
              id: "attachment4",
              type: "file",
