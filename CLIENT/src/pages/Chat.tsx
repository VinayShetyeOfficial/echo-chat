...
import { Loader2, MessageSquare, User as UserIcon, Hash } from "lucide-react"
import { Button } from "@/components/ui/button"
import { CreateChannelDialog } from "@/components/CreateChannelDialog"
import { useIsMobile } from "@/hooks/use-mobile"

export default function Chat() {
  const { activeChannel, messages, sendMessage, editMessage, deleteMessage, loading, createChannel, channels } =
    useChat()
  ...
  return (
    <SettingsProvider>
      <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-900">
        <ChatSidebar isOpen={isMobileMenuOpen} onToggle={toggleMobileMenu} onCreateChannel={openCreateChannel} />
            ...
            <div className="text-center max-w-md p-8 bg-white dark:bg-gray-800 rounded-xl shadow-sm border dark:border-gray-700">
              ...
              <p className="text-muted-foreground mb-6 dark:text-gray-400">
                {channels.length > 0
                  ...
                  : "Create a new channel or direct message to start chatting. Use the sidebar to invite others."}
              </p>
